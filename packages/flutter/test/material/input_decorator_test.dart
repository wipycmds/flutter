...
void main() {
  ...
  group('Material2', () {
    ...
    testWidgets('prefixIcon in RTL with asymmetric padding', (WidgetTester tester) async {
      ...
      final Offsetdx: final double decoratorRight = tester.getTopRight(find.byType(InputDecorator));
      final Offsetdx: final double prefixRight = tester.getTopRight(find.byType(Icon));
